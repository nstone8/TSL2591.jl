...
LuxSensor(i2c)
```
Connect to a tsl2591 lux sensor via Blinka. The i2c argument should be a CircuitPython object representing the i2c channel to communicate on
